        ...
        <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              disabled={loading || googleLoading}
              className="w-full bg-white hover:bg-slate-50 disabled:opacity-50 text-slate-700 font-bold py-3 rounded-xl transition-all flex items-center justify-center gap-3 shadow-md hover:shadow-lg active:scale-[0.98]"
            >
              {googleLoading ? (
                ...
                <>
                  ...
                  <span className="text-sm">{mode === 'login' ? 'Entrar com Google' : 'Cadastrar com Google'}</span>
                </>
              )}
            </button>
          </form>
